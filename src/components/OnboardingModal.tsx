    ...
    <div className="fixed inset-0 z-[100] bg-black/70 backdrop-blur-sm flex items-center justify-center p-4">
      <div className="card w-full max-w-[420px] p-7 shadow-2xl animate-in fade-in zoom-in-95 duration-200 border border-border bg-card">
        <div className="flex items-center gap-3 mb-5">
          ...
          <div>
            <h2 className="text-[17px] font-bold text-foreground">Welcome to Hive!</h2>
          ...
          <div>
            ...
            <div className="relative">
              <input
                ...
                className="hive-input pl-9 text-[13px]"
              />
            </div>
          </div>
          ...
          <div>
            ...
            <div className="relative">
              <select
                ...
                className="hive-input pl-9 text-[13px] cursor-pointer"
              >
