...
function LoginFormContent() {
  ...
  if (errorParam === "EduEmailRequired") {
    defaultError = "Access Restricted: Institutional .edu / .ac.in email or admin verification required.";
      ...
      <div className="hidden lg:flex" style={{
        ...
        <div style={{ position: "relative", zIndex: 10, maxWidth: 440 }}>
          <h1 style={{
            ...
            Welcome<br />back<span style={{ opacity: 0.3 }}>.</span>
          </h1>
          <p style={{
            ...
            Your next project is waiting. Your next collaborator is already here.
          </p>
        </div>
      ...
      <div style={{
        ...
        <div style={{ width: "100%", maxWidth: 380, position: "relative" }}>
          ...
          <div>
            ...
            {defaultError && (
              <div style={{
                padding: "1rem", marginTop: 20, marginBottom: 24, fontSize: "0.75rem", textAlign: "left",
                borderRadius: 12, background: "rgba(220,38,38,0.08)", color: "#f87171",
                border: "1px solid rgba(220,38,38,0.15)",
              }}>
                <p style={{ fontWeight: 600, margin: "0 0 0.5rem" }}>{defaultError}</p>
                <button
                  type="button"
                  onClick={() => setShowIdModal(true)}
                  style={{ fontSize: "0.6875rem", textDecoration: "underline", fontWeight: 700, cursor: "pointer", background: "none", border: "none", color: "#f87171", padding: 0 }}
                >
            ...
            <button
              ...
              style={{
                ...
                transition: "background 0.15s", marginTop: 28,
              }}
            >
          ...
          <p style={{
            ...
            New here?{" "}
            <Link href="/signup" style={{ fontWeight: 600, color: "#EDEDED", textDecoration: "none" }}>
              Create an account
            </Link>
          </p>
        </div>
  ...
  return (
    <Suspense fallback={
      <div style={{
        ...
        <p style={{ fontFamily: "var(--font-body)", fontSize: "0.8125rem", color: "#666" }}>Loading...</p>
      </div>
    }>
      <LoginFormContent />
    </Suspense>
