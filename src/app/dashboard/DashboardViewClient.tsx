    ...
    <div className="flex-1 p-5 md:p-7 space-y-6">
      ...
      {currentTab === "home" && (
        <div className="space-y-6">
          ...
          <div className="flex items-center justify-between gap-4 pb-5 border-b border-border">
            <div>
              <h1 style={{ fontFamily: "var(--font-display), system-ui, sans-serif", fontWeight: 800, fontSize: "clamp(1.25rem, 2.5vw, 1.5rem)", letterSpacing: "-0.04em", color: "var(--foreground)" }} className="leading-tight">
                Welcome back, {currentUser?.name?.split(" ")[0] || "there"}.
              </h1>
              <p style={{ fontFamily: "var(--font-body), system-ui, sans-serif", fontSize: "0.8125rem", color: "var(--muted-foreground)" }} className="mt-0.5">
                {projects.length > 0
                  ? `You have ${projects.length} active project${projects.length !== 1 ? "s" : ""}.`
                  : "Start by posting your first project."}
              </p>
            </div>
            <Link href="/projects/create" style={{ fontFamily: "var(--font-body), system-ui, sans-serif", fontSize: "0.75rem", fontWeight: 600 }} className="btn-primary py-2 px-3.5 shrink-0 flex items-center gap-1.5">
          ...
          <div className="grid grid-cols-2 sm:grid-cols-4 gap-3">
            {[
              ...
              <Link key={label} href={href}
                style={{ background: "#111111", border: "1px solid rgba(255,255,255,0.04)", boxShadow: "0 4px 24px rgba(0,0,0,0.3)" }}
                className="px-4 py-3.5 flex flex-col gap-1 hover:border-muted-foreground/25 transition-all rounded-xl"
              >
                <span style={{ fontFamily: "var(--font-display), system-ui, sans-serif", fontWeight: 800, fontSize: "1.5rem", letterSpacing: "-0.04em", color: "var(--foreground)", fontVariantNumeric: "tabular-nums" }} className="leading-none">{value}</span>
                <span style={{ fontFamily: "var(--font-mono), monospace", fontSize: "0.625rem", fontWeight: 500, color: "var(--muted-foreground)" }}>{label}</span>
              </Link>
            ))}
          </div>
          ...
          <div className="space-y-3">
            <div className="flex items-center justify-between">
              <h2 style={{ fontFamily: "var(--font-display), system-ui, sans-serif", fontWeight: 700, fontSize: "0.8125rem", letterSpacing: "-0.03em", color: "var(--foreground)" }}>Open to join</h2>
              <Link href="/projects" style={{ fontFamily: "var(--font-body), system-ui, sans-serif", fontSize: "0.6875rem", fontWeight: 500, color: "var(--muted-foreground)" }} className="hover:text-foreground transition-colors flex items-center gap-0.5">
                Browse all →
              </Link>
            </div>
            ...
            <div className="space-y-2">
              {recommendedProjects && recommendedProjects.length > 0 ? (
                recommendedProjects.map((project) => {
                  ...
                  return (
                    <article key={project.id} style={{ background: "#111111", border: "1px solid rgba(255,255,255,0.04)", boxShadow: "0 4px 24px rgba(0,0,0,0.3)" }} className="p-4 flex items-start gap-3 transition-all group rounded-xl">
                      ...
                      <div className="flex-1 min-w-0">
                        <div className="flex items-center justify-between gap-2 mb-1">
                          <h3 style={{ fontFamily: "var(--font-display), system-ui, sans-serif", fontWeight: 700, fontSize: "0.8125rem", letterSpacing: "-0.02em", color: "var(--foreground)" }} className="leading-snug line-clamp-1 group-hover:underline underline-offset-2">
                        ...
                        <p style={{ fontFamily: "var(--font-body), system-ui, sans-serif", fontSize: "0.6875rem", color: "var(--muted-foreground)" }} className="line-clamp-1 leading-relaxed mb-1.5">
                          {project.description}
                        </p>
                        <div className="flex items-center justify-between gap-2">
                          <div className="flex flex-wrap gap-1">
                            {project.skills?.slice(0, 3).map((skill: any) => (
                              <span key={skill.id} style={{ fontFamily: "var(--font-mono), monospace", fontSize: "0.5625rem", fontWeight: 500 }} className="px-1.5 py-0.5 rounded bg-secondary border border-border text-muted-foreground">
                                {skill.name}
                              </span>
                            ))}
                          </div>
                          <span style={{ fontFamily: "var(--font-body), system-ui, sans-serif", fontSize: "0.625rem", color: "var(--muted-foreground)" }} className="shrink-0">by {project.owner?.name}</span>
                        </div>
                      </div>
                    </article>
                  );
                ...
                <div style={{ background: "#111111", border: "1px solid rgba(255,255,255,0.04)", boxShadow: "0 4px 24px rgba(0,0,0,0.3)", fontFamily: "var(--font-body), system-ui, sans-serif", fontSize: "0.75rem", color: "var(--muted-foreground)" }} className="p-8 text-center rounded-xl">No open projects at the moment.</div>
              )}
            </div>
          </div>
          ...
          {/* Recent activity */}
          <div className="space-y-3">
            <h2 style={{ fontFamily: "var(--font-display), system-ui, sans-serif", fontWeight: 700, fontSize: "0.8125rem", letterSpacing: "-0.03em", color: "var(--foreground)" }}>Recent activity</h2>
            <div style={{ background: "#111111", border: "1px solid rgba(255,255,255,0.04)", boxShadow: "0 4px 24px rgba(0,0,0,0.3)" }} className="overflow-hidden divide-y divide-border rounded-xl">
              {recentNotifications && recentNotifications.length > 0 ? (
                recentNotifications.slice(0, 4).map((notif) => (
                  <Link
                    key={notif.id}
                    href={getNotificationLink(notif)}
                    style={{ fontFamily: "var(--font-body), system-ui, sans-serif", fontSize: "0.75rem" }}
                  ...
                  >
                    ...
                    <span style={{ fontFamily: "var(--font-body), system-ui, sans-serif", fontSize: "0.625rem", color: "var(--muted-foreground)" }} className="shrink-0 ml-2">
                      {new Date(notif.createdAt).toLocaleDateString(undefined, { month: "short", day: "numeric" })}
                    </span>
                  </Link>
                ))
              ) : (
                <p style={{ fontFamily: "var(--font-body), system-ui, sans-serif", fontSize: "0.75rem", color: "var(--muted-foreground)" }} className="px-4 py-6 text-center">No recent activity.</p>
              )}
            </div>
          </div>
          ...
          <div className="space-y-4 hidden lg:block">
            ...
            {/* My Projects */}
            <div style={{ background: "#111111", border: "1px solid rgba(255,255,255,0.04)", boxShadow: "0 4px 24px rgba(0,0,0,0.3)" }} className="p-4 rounded-xl">
              <div className="flex items-center justify-between mb-3">
                <h3 style={{ fontFamily: "var(--font-body), system-ui, sans-serif", fontWeight: 700, fontSize: "0.75rem", letterSpacing: "-0.01em", color: "var(--foreground)" }}>My projects</h3>
                <Link href="/projects/create" style={{ fontFamily: "var(--font-mono), monospace", fontSize: "0.625rem", fontWeight: 600, color: "var(--muted-foreground)" }} className="hover:text-foreground transition-colors">+ New</Link>
              </div>
                ...
                {myProjectsSidebar && myProjectsSidebar.length > 0 ? (
                  myProjectsSidebar.map((proj) => (
                    <div key={proj.id} className="flex items-center justify-between gap-2">
                      <Link href={`/projects/${proj.id}`} style={{ fontFamily: "var(--font-body), system-ui, sans-serif", fontSize: "0.75rem", fontWeight: 500, color: "var(--foreground)" }} className="hover:underline underline-offset-2 line-clamp-1 min-w-0">{proj.title}</Link>
                      <span className={`flex items-center gap-1 shrink-0 ${proj.status === "OPEN" ? "text-green-600 dark:text-green-400" : "text-muted-foreground"}`}>
                  ...
                  <p style={{ fontFamily: "var(--font-body), system-ui, sans-serif", fontSize: "0.6875rem", color: "var(--muted-foreground)" }}>No projects yet.</p>
                )}
              </div>
              <div className="border-t border-border mt-3 pt-2.5">
                <Link href="/dashboard?tab=projects" style={{ fontFamily: "var(--font-body), system-ui, sans-serif", fontSize: "0.6875rem", fontWeight: 500, color: "var(--muted-foreground)" }} className="hover:text-foreground transition-colors">All projects →</Link>
              </div>
            </div>
            ...
            <div style={{ background: "#111111", border: "1px solid rgba(255,255,255,0.04)", boxShadow: "0 4px 24px rgba(0,0,0,0.3)" }} className="p-4 rounded-xl">
              <div className="flex items-center justify-between mb-3">
                <h3 style={{ fontFamily: "var(--font-body), system-ui, sans-serif", fontWeight: 700, fontSize: "0.75rem", letterSpacing: "-0.01em", color: "var(--foreground)" }}>Applications</h3>
                <Link href="/dashboard?tab=applications" style={{ fontFamily: "var(--font-mono), monospace", fontSize: "0.625rem", fontWeight: 600, color: "var(--muted-foreground)" }} className="hover:text-foreground transition-colors">View all</Link>
              </div>
              <div className="space-y-2.5">
                {myApplicationsSidebar && myApplicationsSidebar.length > 0 ? (
                  myApplicationsSidebar.map((app) => (
                    <div key={app.id} className="flex items-center justify-between gap-2">
                      <Link href={`/projects/${app.project.id}`} style={{ fontFamily: "var(--font-body), system-ui, sans-serif", fontSize: "0.75rem", fontWeight: 500, color: "var(--foreground)" }} className="hover:underline underline-offset-2 line-clamp-1 min-w-0">{app.project.title}</Link>
                      <span className={`shrink-0 ${app.status === "ACCEPTED" ? "text-green-600 dark:text-green-400" : app.status === "REJECTED" ? "text-red-500" : "text-muted-foreground"}`}>
                        {app.status === "ACCEPTED" ? "Accepted" : app.status === "REJECTED" ? "Rejected" : "Pending"}
                      </span>
                    </div>
                  ))
                ) : (
                  <p style={{ fontFamily: "var(--font-body), system-ui, sans-serif", fontSize: "0.6875rem", color: "var(--muted-foreground)" }}>No applications yet.</p>
                )}
              </div>
            </div>
            ...
            {myBookmarksSidebar && myBookmarksSidebar.length > 0 && (
              <div style={{ background: "#111111", border: "1px solid rgba(255,255,255,0.04)", boxShadow: "0 4px 24px rgba(0,0,0,0.3)" }} className="p-4 rounded-xl">
                <div className="flex items-center justify-between mb-3">
                  <h3 style={{ fontFamily: "var(--font-body), system-ui, sans-serif", fontWeight: 700, fontSize: "0.75rem", letterSpacing: "-0.01em", color: "var(--foreground)" }}>Saved</h3>
                  <Link href="/dashboard?tab=bookmarks" style={{ fontFamily: "var(--font-mono), monospace", fontSize: "0.625rem", fontWeight: 600, color: "var(--muted-foreground)" }} className="hover:text-foreground transition-colors">View all</Link>
                </div>
                <div className="space-y-2">
                  {myBookmarksSidebar.map((bm) => (
                    <div key={bm.project.id} className="flex items-center gap-2">
                      ...
                      <Link href={`/projects/${bm.project.id}`} style={{ fontFamily: "var(--font-body), system-ui, sans-serif", fontSize: "0.75rem", fontWeight: 500, color: "var(--foreground)" }} className="hover:underline underline-offset-2 line-clamp-1">{bm.project.title}</Link>
                    </div>
                  ))}
                </div>
              </div>
          ...
          <div className="sm:hidden grid grid-cols-3 gap-2 pt-1">
            {[
              ...
              <Link key={label} href={href} style={{ background: "#111111", border: "1px solid rgba(255,255,255,0.04)", boxShadow: "0 4px 24px rgba(0,0,0,0.3)" }} className="flex flex-col items-center gap-1.5 p-3 transition-all rounded-xl">
                ...
                <span style={{ fontFamily: "var(--font-body), system-ui, sans-serif", fontSize: "0.625rem", fontWeight: 500, color: "var(--foreground)" }} className="text-center">{label}</span>
              </Link>
            ))}
          </div>
        ...
        return (
          <div className="space-y-6">
            <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
              <div>
                <h2 className="text-[17px] font-display font-bold text-foreground tracking-tight">Events &amp; Competitions</h2>
      ...
      {currentTab === "bookmarks" && (
        <div className="space-y-5">
          <div>
            <h2 className="text-[17px] font-display font-semibold text-foreground tracking-tight">Bookmarks</h2>
      ...
      {currentTab === "projects" && (
        <div className="space-y-6">
          <div className="flex items-center justify-between">
            <div>
              <h2 className="text-[17px] font-display font-semibold text-foreground tracking-tight">My projects</h2>
      ...
      {currentTab === "applications" && (
        <div className="space-y-5">
          <div>
            <h2 className="text-[17px] font-display font-semibold text-foreground tracking-tight">My applications</h2>
      ...
      {currentTab === "invitations" && (
        <div className="space-y-6">
          <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 pb-4 border-b border-border">
            <div>
              <h2 className="text-[17px] font-display font-bold text-foreground tracking-tight flex items-center gap-2">
            ...
            <form onSubmit={handleSendInvitation} className="space-y-4">
              {!inviteTargetUser ? (
                <div>
                  ...
                  <select
                    ...
                    className="hive-input cursor-pointer"
                  >
              ...
              <div>
                ...
                <textarea
                  ...
                  className="hive-input resize-none"
                />
              </div>
      ...
      {currentTab === "notifications" && (
        <div className="space-y-5">
          <div className="flex items-center justify-between">
            <div>
              <h2 className="text-[17px] font-display font-semibold text-foreground tracking-tight">Notifications</h2>
      ...
      {currentTab === "profile" && (
        <div className="space-y-5">
          <div>
            <h2 className="text-[17px] font-display font-semibold text-foreground tracking-tight">Profile settings</h2>
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-2 border-b border-border/50 pb-4">
        <div>
          <div className="flex items-center gap-2">
            <h2 className="text-[18px] font-display font-semibold text-foreground tracking-tight">Find collaborators</h2>
        ...
        <div className="grid grid-cols-1 md:grid-cols-12 gap-2.5 items-center">
          ...
          <div className="relative md:col-span-6">
            ...
            <input
              ...
              className="hive-input pl-9 w-full bg-card"
            />
            {collabSearch && (
              <button
